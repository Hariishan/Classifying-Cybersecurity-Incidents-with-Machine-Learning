...
# Use RandomizedSearchCV with adjusted n_iter
random_search = RandomizedSearchCV(
    estimator=pipeline,
    param_distributions=param_dist,
    n_iter=16,  # Set to the total number of available parameter combinations
    cv=5,
    scoring='accuracy',
...
print("Starting model training with Random Search...")
start_time = time.time()
